  ...
  const signupHandler = (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    if (Array.isArray(allUsers)) {
      ...
      if (userExists && userExists.length) {
        setUserExists({ exists: true, message: "User already exists, please Login" })
      } else {
          ...
          <form className="box">
            ...
            <div className="field">
              ...
              <div className="control">
                <input
                  className={`input ${mobile.error ? "is-danger" : "is-success"}`}
                  type="tel"
              ...
              {mobile.error ? (
                <label className="label">
                  <i className="fas fa-exclamation-circle"></i> Please enter a valid indian mobile number (Don't use prefixes Ex: +91, 0)
                </label>
            ) : null}
            </div>
            ...
            <div className="field has-icons-left">
              ...
              {password.error ? (
                <label className="label">
                  <i className="fas fa-exclamation-circle"></i> <span className="is-danger">Password should be minimun 8 digits.</span>
                </label>
            ) : null}
            </div>
            ...
            <div className="field">
              ...
              <div className="control has-icons-left">
                <input
                  className={`input ${rePassword.error ? "is-danger" : "is-success"}`}
                  type="password"
              ...
              {rePassword.error ? (
                <label className="label">
                  <i className="fas fa-exclamation-circle"></i> <span className="is-danger">Password not matching with the above typed password</span>
                </label>
            ) : null}
            </div>
